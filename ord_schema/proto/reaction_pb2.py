...
_BINARYDATA = _descriptor.Descriptor(
  name='BinaryData',
  full_name='ord.BinaryData',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='value', full_name='ord.BinaryData.value', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='description', full_name='ord.BinaryData.description', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='format', full_name='ord.BinaryData.format', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_REACTIONSETUP_AUTOMATIONCODEENTRY.fields_by_name['value'].message_type = _BINARYDATA
...
_REACTIONOBSERVATION.fields_by_name['image'].message_type = _BINARYDATA
...
_REACTIONANALYSIS_PROCESSEDDATAENTRY.fields_by_name['value'].message_type = _BINARYDATA
_REACTIONANALYSIS_PROCESSEDDATAENTRY.containing_type = _REACTIONANALYSIS
_REACTIONANALYSIS_RAWDATAENTRY.fields_by_name['value'].message_type = _BINARYDATA
...
DESCRIPTOR.message_types_by_name['BinaryData'] = _BINARYDATA
...
BinaryData = _reflection.GeneratedProtocolMessageType('BinaryData', (_message.Message,), {
  ...
  '__module__' : 'proto.reaction_pb2'
  # @@protoc_insertion_point(class_scope:ord.BinaryData)
  })
